...
import static com.jakir.permissions.PermissionsRuntime.checkRationale_RequestMultiplePermission;
...
//
// Created by JAKIR HOSSAIN on 8/8/2025.
//
public class Bottomsheet_dialog_Multiple {
    LottieAnimationView lottie;
    TextView tittle_tv, tittle_tvi, message_tv;
    ImageView close_iv, Primage;
    Context context;
    Button allow_btn;
    String pDisplayName = "Multiple";

    public Bottomsheet_dialog_Multiple(Context context) {
